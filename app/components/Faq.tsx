...
const items = [
  {
    question: "Lets clarify some of your questions",
    answer:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam ipsa vero nulla error similique laudantium atque illo officia quis, delectus officiis sit tenetur enim necessitatibus veritatis iusto fugiat voluptatum tempore.",
  },
  {
    question: "Lets clarify some of your questions",
    answer:
    ...
    <div className="flex flex-col w-full py-[48px] lg:py-[60px] lg:flex-row lg:gap-x-6">
      <div className="lg:w-1/3 lg:py-[32px] lg:pr-[56px]">
        ...
        <p className="text-[#36485C] pb-[24px]">
          ...
          nemo eius, reiciendis consectetur nobis
        </p>
      </div>
